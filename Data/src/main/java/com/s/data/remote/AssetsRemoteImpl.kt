...
class AssetsRemoteImpl constructor(private val inPlayerRemoteServiceAPI: InPlayerRemoteServiceAPI,
    ...
    override fun getExternalAsset(assetType: String, externalId: String): Single<ItemDetailsModel> {
        return inPlayerRemotePublicServiceAPI.getExternalAsset(assetType = assetType, externalId = externalId)
    }
