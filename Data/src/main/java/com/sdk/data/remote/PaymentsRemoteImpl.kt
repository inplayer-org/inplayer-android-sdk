...
class PaymentsRemoteImpl constructor(private val inPlayerRemoteServiceAPI: InPlayerRemoteServiceAPI
                                    ) : PaymentsRemote {
    ...
    override fun getCustomerAccessList(status: String, page: Int, limit: Int, type: String?) = inPlayerRemoteServiceAPI.getCustomerAccessList(status, page, limit, type)
